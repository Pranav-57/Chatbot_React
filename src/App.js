...
function App() {
  ...
  const [initialMessage, setInitialMessage] = useState("The possible dieseases with their probability based on given symptoms are as follows")
  ...
  const sendResponse = async () => {
    ...
    try {
      ...
      if (data.bot_reply) {
        msg.text = data.bot_reply;
        msg.lang = 'hi';
        window.speechSynthesis.speak(msg);
      }
      else{
        // console.log(data.possible_diseases);

        // var msg = new SpeechSynthesisUtterance();
        var output = "The possible dieseases with their probability based on given symptoms are as follows ";
        var disease_count = 0;
                  ...
                  return messages.boy_reply ? (
                    typeof messages.boy_reply === "object" ? (
                      <div className="bot_message d-flex align-items-center mb-3">
                        ...
                        The possible dieseases with their probability based on given symptoms are as follows :-
